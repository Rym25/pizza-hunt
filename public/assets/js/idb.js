...
request.onupgradeneeded = function (event) {
    ...
    // create an object store (table) called `new_pizza`, set it ot have an auto incrementing primary key of sorts
...
function saveRecord(record) {
    // open a new transaction with the dataset with read and write permissions
